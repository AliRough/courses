      ...
      <div className='card-header bg-transparent border-bottom'>
        <div className='row justify-content-between align-middle'>
          <div className='col-sm-6'>
            <h3 className='card-header-title mb-2 mb-sm-0 fs-5 ff-vb'>
              دیدگاه ها
            </h3>
          </div>
          <div className='col-sm-4'>
            <form>
              <select
                className='form-select js-choice z-index-9 bg-white'
      ...
      <div className='card-body mt-2 mt-sm-4'>
        <div className='d-sm-flex'>
          ...
          <div>
            ...
            <h6 className='fw-normal'>
              <span className='text-body fw-light'>دیدگاه درمورد:</span> نحوه
              پیاده سازی نقشه سایت در sass
            </h6>
            <p>
            ...
            <div className='text-end'>
              <a href='#' className='btn btn-sm btn-primary-soft mb-1 mb-sm-0'>
                دایرکت
              </a>
              <a
        ...
        <div className='d-sm-flex'>
          ...
          <div>
            ...
            <h6 className='fw-normal'>
              <span className='text-body fw-light'>دیدگاه درمورد:</span> یک
              برنامه Angular چگونه کار می کند؟
            </h6>
            <p>
        ...
        <div className='d-sm-flex'>
          ...
          <div>
            ...
            <h6 className='fw-normal'>
              <span className='text-body fw-light'>دیدگاه درمورد:</span> Flexbox
              چیست و در مورد خواص پرکاربرد آن توضیح دهید؟
            </h6>
            <p>
        ...
        <div className='d-sm-flex'>
          ...
          <div>
            ...
            <h6 className='fw-normal'>
              <span className='text-body fw-light'>دیدگاه درمورد:</span> انواع
              داده های مختلف موجود در جاوا اسکریپت چیست؟
            </h6>
            <p>
              در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
              شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای
        ...
        <div className='d-sm-flex'>
          ...
          <div>
            ...
            <h6 className='fw-normal'>
              <span className='text-body fw-light'>دیدگاه درمورد:</span> نمونه
              های اولیه شی چیست؟
            </h6>
            <p>
              کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان
...
export default ProfileTeacherReview;
