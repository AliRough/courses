                    ...
                    <table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" className="border-0">کد پیگیری</th>
                                <th scope="col" className="border-0">تاریخ</th>
                                <th scope="col" className="border-0">قیمت</th>
                                <th scope="col" className="border-0 rounded-end">روش پرداخت</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">دوره کامل دیجیتال مارکتینگ - دوره 8 در 1</a></h6>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">آموزش مقدماتی فتوشاپ Photoshop</a></h6>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">دوره جامع آموزش Sketch</a></h6>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">دوره جامع آموزش Figma</a></h6>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">دوره جامع آموزش HTML</a></h6>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 className="table-responsive-title mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">دوره جامع آموزش JavaScript</a></h6>
                                </td>
