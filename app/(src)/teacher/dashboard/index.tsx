                ...
                <div className="card card-body bg-transparent border p-4 h-100">
                    <div className="row g-4">
                        ...
                        <div className="col-sm-6 col-md-4">
                            ...
                            <p className="mb-0"><span className="text-success me-1">0.20%<i className="bi bi-arrow-up"></i></span>نسبت به ماه قبل</p>
                        </div>

                        <div className="col-sm-6 col-md-4">
                            <span className="badge text-bg-dark">ماه گذشته</span>
                            <h4 className="my-2 fs-5">75,000 تومان</h4>
                            <p className="mb-0"><span className="text-danger me-1">0.10%<i className="bi bi-arrow-down"></i></span>نسبت به ماه قبل</p>
                        </div>
                    </div>
                ...
                <div className="card border bg-transparent rounded-3 mt-5">
                    ...
                    <div className="card-header bg-transparent border-bottom">
                        <div className="d-sm-flex justify-content-sm-between align-items-center">
                            ...
                            <a href="#" className="btn btn-sm btn-primary-soft mb-0">مشاهده</a>
                        </div>
                    </div>
                            ...
                            <table className="table table-dark-gray align-middle p-4 mb-0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" className="border-0">فروش</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="w-60px">
                                                    <Image unoptimized={true} width='500' height='500' src="/images/courses/4by3/08.jpg" className="rounded" alt="" />
                                                </div>
                                        ...
                                        <td>
                                            <span className="badge bg-primary bg-opacity-10 text-primary">9 ماه</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="w-60px">
                                                    <Image unoptimized={true} width='500' height='500' src="/images/courses/4by3/10.jpg" className="rounded" alt="" />
                                                </div>
                                        ...
                                        <td>
                                            <span className="badge bg-primary bg-opacity-10 text-primary">6 ماه</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="w-60px">
                                                    <Image unoptimized={true} width='500' height='500' src="/images/courses/4by3/02.jpg" className="rounded" alt="" />
                                                </div>
                                        ...
                                        <td>
                                            <span className="badge bg-primary bg-opacity-10 text-primary">4 ماه</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="w-60px">
                                                    <Image unoptimized={true} width='500' height='500' src="/images/courses/4by3/04.jpg" className="rounded" alt="" />
                                                </div>
                                        ...
                                        <td>
                                            <span className="badge bg-primary bg-opacity-10 text-primary">8 ماه</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="w-60px">
                                                    <Image unoptimized={true} width='500' height='500' src="/images/courses/4by3/06.jpg" className="rounded" alt="" />
                                                </div>
                                        ...
                                        <td>
                                            <span className="badge bg-primary bg-opacity-10 text-primary">1 سال</span>
                                        </td>
