        ...
        <div className="row g-4 mb-4">
            ...
            <div className="col-sm-6 col-md-4">
                <div className="border p-3 rounded-3 h-100">
                    <div className="d-flex mb-1 justify-content-between align-items-center">
                        ...
                        <span className="badge bg-success bg-opacity-10 text-success ms-2 mb-0">پرداخت شده</span>
                    </div>
            ...
            <div className="col-sm-6 col-md-4">
                <div className="bg-primary bg-opacity-10 h-100 p-3 rounded-3">
                    ...
                    <a href="#" className="btn btn-sm btn-primary mb-0">برداشت سود</a>
                </div>
            </div>
        </div>
            ...
            <div className="card-body">
                ...
                <div className="table-responsive border-0">
                    <table className="table table-dark-gray align-middle p-4 mb-0 table-hover">
                        ...
                        <thead>
                            <tr>
                                <th scope="col" className="border-0 rounded-start">پرداختی</th>
                                <th scope="col" className="border-0">مبلغ</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 className="mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">پرداخت موفق #102356</a></h6>
                                </td>
                                ...
                                <td className="text-center text-sm-start">
                                    <span className="badge bg-success bg-opacity-10 text-success">پرداخت شده</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <h6 className="mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">پرداخت موفق #102589</a></h6>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 className="mt-2 mt-lg-0 mb-0 fw-normal"><a href="#">پرداخت موفق #108645</a></h6>
                                </td>
                                ...
                                <td className="text-center text-sm-start">
                                    <span className="badge bg-danger bg-opacity-10 text-danger">کنسل شده </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td className="text-center text-sm-start">
                                    <span className="badge bg-orange bg-opacity-10 text-orange">در انتظار پرداخت</span>
                                </td>
