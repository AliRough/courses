            ...
            <div className='accordion-item mb-3'>
              ...
              >
                <div className='accordion-body mt-3'>
                  <p className='mb-3'>
                    <b className='text-dark'>A</b> ساخت رابط کاربری و بررسی
                    پروژه عملی دوره
                  </p>
                  <p className='mb-3'>
                    <b className='text-dark'>B</b> بررسی ابزار ها و ایجاد پروژه
                  </p>
                  <p className='mb-3'>
                    <b className='text-dark'>C</b> پیش نیاز های دوره و نصب پیش
                    نیاز ها
                  </p>
                  <p className='mb-3'>
                    <b className='text-dark'>D</b> طراحی رابط کاربری اپلیکیشن
                  </p>
                  <a
                    href='#'
            ...
            <table className='table table-dark-gray align-middle p-4 mb-0 table-hover'>
              ...
              <tbody>
                <tr>
                  <td>
                    <div className='d-flex align-items-center'>
                      ...
                      <div>
                        <h6 className='mb-0'>
                          <a href='#'>الهام حسینی</a>
                        </h6>
                      </div>
                    </div>
                  </td>
                  <td>
                    <h6 className='table-responsive-title mt-2 mt-md-0 mb-0 fw-normal'>
                      <a href='#'>
                        دوره های کامل بازاریابی دیجیتال - 12 دوره در 1
                      </a>
                    </h6>
                  </td>
                  <td>1400/1/12</td> <td>450/500</td>
                  <td>
                    <a
                      href='#'
                      className='btn btn-success-soft btn-round mb-0'
                ...
                <tr>
                  ...
                  <td>1399/11/14</td> <td>385/500</td>
                  <td>
                    <a
                      href='#'
                      className='btn btn-success-soft btn-round mb-0'
