              ...
              <div className='card-body'>
                <div className='bs-stepper-content'>
                  <form onsubmit='return false'>
                        ...
                        <div className='col-12'>
                          ...
                          >
                            ...
                            <p>
                              ...
                              موجود در ارائه راهکارها و شرایط سخت تایپ به پایان
                              رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی
                              و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی
                            ...
                            <p>
                              ...
                              و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل
                    ...
                    >
                      <h4 className='fs-5 ff-vb'>رسانه</h4> <hr />
                      <div className='row'>
                        <div className='col-12'>
                              ...
                              <label>
                                <span>
                                  <div className='input-group'>
                                    <input
                                      type='text'
                                      className='form-control stretched-link upload-name border-end-0'
                                      name='my-image'
                                      id='image'
                                  ...
                                  <input
                                    type='file'
                                    className='d-none hidden-upload'
                                  />
                                </span>
                              </label>
                              <p className='small mb-0 mt-2'>
                                <b>توجه: </b> فقط JPG، JPEG و PNG. ابعاد
                                پیشنهادی ما 600px * 450px است. تصویر بزرگتر به
                                اندازه 4:3 برش داده می شود تا با تصاویر کوچک/پیش
                                نمایش ما مطابقت داشته باشد.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className='col-12'>
                          ...
                          <div className='col-12 mt-4 mb-5'>
                            ...
                            <input
                              className='form-control'
                              type='text'
                              placeholder='https://www.aparat.com/video/video/embed/videohash/TyGZt/vt/frame'
                            />
                          </div>
                          ...
                          <div className='col-12'>
                            ...
                            <div className='input-group mb-3'>
                              <label className='input-group-text' dir='ltr'>
                                .mp4
                              </label>
                              <input
                                type='text'
                                className='form-control upload-name-mp4 border-end-0'
                                id='inputGroupFile01'
                              />
                              <span className='btn btn btn-secondary-soft cursor-pointer upload-button-mp4 border-start-0'>
                                آپلود فایل
                              </span>
                            </div>
                            <input
                              type='file'
                              className='d-none hidden-upload-mp4'
                            />
                            <div className='input-group mb-3'>
                              <label className='input-group-text' dir='ltr'>
                                .WebM
                              ...
                              <input
                                type='text'
                                className='form-control upload-name-web border-end-0'
                                id='inputGroupFile02'
                              />
                              <span className='btn btn btn-secondary-soft cursor-pointer upload-button-web border-start-0'>
                                آپلود فایل
                              </span>
                            </div>
                            <input
                              type='file'
                              className='d-none hidden-upload-web'
                            />
                            <div className='input-group mb-3'>
                              <label className='input-group-text' dir='ltr'>
                                .OGG
                              ...
                              <input
                                type='text'
                                className='form-control upload-name-ogg border-end-0'
                                id='inputGroupFile03'
                              />
                              <span className='btn btn btn-secondary-soft cursor-pointer upload-button-ogg border-start-0'>
                                آپلود فایل
                              </span>
                            </div>
                            <input
                              type='file'
                              className='d-none hidden-upload-ogg'
                            />
                          </div>
                          ...
                          <div className='bg-light border rounded p-4'>
                            ...
                            <div className='mt-3'>
                              ...
                              <span className='small'>
                                حداکثر 14 کلمه کلیدی کلمات کلیدی همگی باید با
                                حروف کوچک و با کاما از هم جدا شوند. به عنوان
                                مثال، javascript، react
                              </span>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className='bg-light border rounded p-4'>
                            ...
                            <div className='mt-3'>
                              ...
                              <div className='form-check mb-0 mt-2'>
                                ...
                                >
                                  هر تصویر، صدا، یا سایر دارایی‌هایی که کار من
                                  نیستند، مجوز مناسبی برای استفاده در پیش‌نمایش
                                  فایل یا دوره اصلی دریافت کرده‌اند. به غیر از
                                  این موارد، این اثر کاملاً متعلق به من است و من
                                  حق کامل فروش آن را در اینجا دارم.
                                </label>
                              </div>
                            </div>
                          </div>
