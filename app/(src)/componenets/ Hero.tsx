  ...
  return (
    <>
      ...
      <>
        {/* =======================
Main Banner START */}
        <section className='position-relative overflow-hidden pb-0 pb-xl-5'>
          {/* SVG decoration */}
          ...
          <div className='container'>
            <div className='row align-items-center justify-content-xl-between justify-content-center '>
              ...
              <div className='col-md-9 col-lg-6 col-xl-5 position-relative z-index-1  text-center text-lg-start mb-2 mb-xl-0'>
                ...
                {/* Search bar */}
                <form className='!tw-border rounded-3 p-2 mb-4 tw-shadow-md bg-white  '>
                  <div className='input-group'>
                    ...
                    <button
                      type='button'
                      className='btn btn-primary mb-0 rounded-3'
                    >
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        fill='none'
