...
export const getDataTest = async () => {
  ...
  try {
    // const data = fetch('https://eduapi.liara.run/api/v1').then((data) =>
    //   JSON.stringify(data),
    // );
    // axios.defaults.baseURL = 'https://eduapi.liara.run/api/v1';

    const data = await axios.get('https://eduapi.liara.run/api/v1/categories');
...
Main Banner END */}
      ...
      {/* -------------------------- */}
      {
        ...
        //             }}
        //           >
        //             <p className='text-white'>دانشجویان جدید امروز ما</p>
        //             {/* Avatar group */}
