                        ...
                        <div className='col-12 position-relative my-2 my-sm-3'>
                            <div className='row align-items-center'>
                                ...
                                <div className='col-lg-6'>
                                    <h3 className='text-white mb-3 mb-lg-0 ff-vb'>دریافت جدیدترین به‌روزرسانی‌های دوره، در خبرنامه ما</h3>
                                </div>
                                
                                <div className='col-lg-6 text-lg-end'>
                                    <form className='bg-body rounded p-2'>
                                        <div className='input-group'>
                                            <input className='form-control border-0 me-1' type='email' placeholder='ایمیل'/>
                                                <button type='button' className='btn btn-dark mb-0 rounded'>عضویت</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
