        ...
        <div className='container position-relative'>
          <div className='row g-4 align-items-center'>
            <div className='col-md-6'>
              ...
              <a href='#fill-instructor-form' className='btn btn-primary mb-0'>
                ثبت نام
              </a>
            </div>
        ...
        <div className='container'>
          <div className='bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden'>
            <figure className='position-absolute top-50 end-0 translate-middle-y me-n7'>
              <svg
                style={{ transform: 'scale(-1,1)' }}
                className='fill-white opacity-8 rotate-193'
                width='676px'
                height='161.3px'
            ...
            <div className='row g-4 position-relative align-items-center justify-content-center'>
              <div className='col-sm-6 col-lg-3 text-center'>
                <div className='d-flex justify-content-center'>
                  <h4
                    className='purecounter display-6 text-orange fw-bold mb-0'
        ...
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-lg-7 z-index-9 mt-5 mt-xl-0'>
              ...
              <ul
                className='nav nav-pills nav-pill-soft my-4'
                id='course-pills-tab'
                role='tablist'
              >
                <li className='nav-item me-2 me-lg-4' role='presentation'>
                  <button
                    className='nav-link mb-2 mb-xl-0 active'
                ...
                >
                  ...
                  <p>
                    ...
                    <Image
                      ...
                      width='500'
                      height='500'
                      src='/images/element/instructor-course.svg'
                      className='rounded float-start me-3 h-200px my-3'
                      alt='...'
                    />
                    لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و
                    با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه
