    ...
    return (<>
        <section className="bg-light py-5 position-relative overflow-hidden">
            ...
            <figure className="fill-primary position-absolute top-50 start-100 translate-middle ms-n7 mt-7 d-none d-sm-block">
                <svg style={{ transform: "scale(-1,1)" }} className="opacity-5" enable-background="new 0 0 160.7 159.8" height="180px">
            ...
            <div className="container position-relative">
                <div className="row g-4 align-items-center">
                    <div className="col-md-6">
                        ...
                        <a href="#fill-instructor-form" className="btn btn-primary mb-0">ثبت نام</a>
                    </div>

                    <div className="col-md-6 text-center">

                        <Image unoptimized={true} width='500' height='500' src="/images/element/04.svg" className="h-300px h-xl-400px" alt="" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <div className="container">
                ...
                <div className="row mb-4">
                    <div className="col-sm-10 col-xl-6 text-center mx-auto">
                        <h2 className="fs-3">مراحل همکاری</h2>
                        <p className="mb-0">کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.</p>
                    </div>
                </div>
                ...
                <div className="row g-4 g-md-5">
                    ...
                    <div className="col-md-4 text-center">
                        <Image unoptimized={true} width='500' height='500' src="/images/element/create-account.svg" className="h-200px" alt="" />
                        <h4 className="mt-3 ff-vb fs-5">ثبت نام</h4>
                        <p className="text-truncate-2 mb-0">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
                    </div>

                    <div className="col-md-4 text-center">
                        <Image unoptimized={true} width='500' height='500' src="/images/element/add-course.svg" className="h-200px" alt="" />
                        <h4 className="mt-3 ff-vb fs-5">افزودن دوره</h4>
                        <p className="text-truncate-2 mb-0">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.
                        </p>
                    </div>

                    <div className="col-md-4 text-center">
                        <Image unoptimized={true} width='500' height='500' src="/images/element/earn-money.svg" className="h-200px" alt="" />
                        <h4 className="mt-3 ff-vb fs-5">درآمدزدایی</h4>
                        <p className="text-truncate-2 mb-0">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                <div className="bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden">
                    ...
                    <figure className="position-absolute top-50 end-0 translate-middle-y me-n7">
                        <svg style={{ transform: "scale(-1,1)" }} className="fill-white opacity-8 rotate-193" width="676px" height="161.3px" viewBox="0 0 676 161.3">
                    ...
                    <figure className="position-absolute top-0 start-0 mt-3 ms-n3 opacity-5">
                        <svg style={{ transform: "scale(-1,1)" }} width="818.6px" height="235.1px" viewBox="0 0 818.6 235.1">
                    ...
                    <div className="row g-4 position-relative align-items-center justify-content-center">
                        ...
                        <div className="col-sm-6 col-lg-3 text-center">
                            ...
                            <h6 className="mb-0 fw-bold">تعداد دانشجویان</h6>
                        </div>
                        ...
                        <div className="col-sm-6 col-lg-3 text-center">
                            ...
                            <h6 className="mb-0 fw-bold">تعداد مدرسان</h6>
                        </div>
                        ...
                        <div className="col-sm-6 col-lg-3 text-center">
                            ...
                            <h6 className="mb-0 fw-bold">تعداد دوره ها</h6>
                        </div>
                        ...
                        <div className="col-sm-6 col-lg-3 text-center">
                            ...
                            <h6 className="mb-0 fw-bold">زبان ها</h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-5 position-relative mt-xl-0" id="fill-instructor-form">
                        ...
                        <figure className="position-absolute top-0 start-50 mt-n3 ms-5 d-none d-sm-block z-index-1">
                            <svg style={{ transform: "scale(-1,1)" }} width="192.5px" height="89.4px" viewBox="0 0 192.5 89.4">
                        ...
                        <div className="card card-body shadow p-4">
                            ...
                            <form className="row g-3 mt-2 position-relative z-index-9">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <input type="text" className="form-control" aria-label="نام و نام خانوادگی" />
                                </div>
                                ...
                                <div className="col-12">
                                    <button type="submit" className="btn btn-primary mb-0">ارسال</button>
                                </div>
                            </form>
                    ...
                    <div className="col-lg-7 z-index-9 mt-5 mt-xl-0">
                        <h3 className="fs-4">مراحل جذب مدرس</h3>
                        <ul className="nav nav-pills nav-pill-soft my-4" id="course-pills-tab" role="tablist">
                            ...
                            <li className="nav-item me-2 me-lg-4" role="presentation">
                                <button className="nav-link mb-2 mb-xl-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">ثبت نام</button>
                            </li>

                            <li className="nav-item me-2 me-lg-4" role="presentation">
                                <button className="nav-link mb-2 mb-xl-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-2" type="button" role="tab" aria-controls="course-pills-2" aria-selected="false">افزودن دوره</button>
                            </li>

                            <li className="nav-item me-2 me-lg-4" role="presentation">
                                <button className="nav-link mb-2 mb-xl-0" id="course-pills-tab-3" data-bs-toggle="pill" data-bs-target="#course-pills-3" type="button" role="tab" aria-controls="course-pills-3" aria-selected="false">درآمدزدایی</button>
                            </li>
                        </ul>
                        ...
                        <div className="tab-content" id="pills-tabContent">
                            ...
                            <div className="tab-pane fade" id="course-pills-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
                                ...
                                <ul className="list-group list-group-borderless mb-3">
                                    <li className="list-group-item">
                                        <i className="fas fa-check-circle text-success me-2"></i>کاربردهای متنوع با هدف بهبود ابزارهای کاربردی
                                    </li>
                                    <li className="list-group-item d-flex">
                                        <i className="fas fa-check-circle text-success me-2 mt-1"></i>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ
                                    </li>
                                    <li className="list-group-item">
                                        <i className="fas fa-check-circle text-success me-2"></i>طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
                                <h6>درآمدزدایی</h6>
                                <p>با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد
                                    <Image unoptimized={true} width='500' height='500' src="/images/element/instructor-course.svg" className="rounded float-start me-3 h-200px my-3" alt="..." /> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت
                                    <u> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است</u> چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section className="pt-0">
            <div className="container position-relative">
                ...
                <figure className="position-absolute top-50 start-50 translate-middle ps-3">
                    <svg style={{ transform: "scale(-1,1)" }} className="fill-white opacity-2">
                ...
                <div className="bg-dark p-4 p-sm-5 rounded-3">
                    <div className="row justify-content-center position-relative">
                        ...
                        <figure className="position-absolute top-50 start-0 translate-middle-y">
                            <svg style={{ transform: "scale(-1,1)" }} width="141px" height="141px">
                        ...
                        <div className="col-11 position-relative">
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-7">
                                    ...
                                    <p className="text-white mb-3 mb-lg-0">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.</p>
                                </div>

                                <div className="col-lg-5 text-lg-end">
                                    <a href="#fill-instructor-form" className="btn btn-lg btn-white mb-0">ثبت نام</a>
                                </div>
                            </div>
                        </div>
                    </div>
