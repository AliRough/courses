        ...
        <div className='col-12'>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='flexCheckDefault9'>همه</label>
                </div>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='flexCheckDefault10'>طراحی وب</label>
                </div>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='flexCheckDefault11'>برنامه نویسی</label>
                </div>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='flexCheckDefault12'>حسابداری</label>
                </div>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='flexCheckDefault17'>بانک اطلاعات</label>
                </div>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='flexCheckDefault13'>داده کاوی</label>
                </div>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='flexCheckDefault14'>شبکه</label>
                </div>
                <span className='small'>(65)</span>
            </div>
            ...
            <div className='d-flex justify-content-between align-items-center'>
                <div className='form-check'>
                    ...
                    <label className='form-check-label' htmlFor='flexCheckDefault15'>عکاسی</label>
                </div>
                ...
                <div className='card card-body p-0'>
                    ...
                    <div className='d-flex justify-content-between align-items-center'>
                        <div className='form-check'>
                            ...
                            <label className='form-check-label' htmlFor='flexCheckDefault16'>طراحی سایت</label>
                        </div>
                    ...
                    <div className='d-flex justify-content-between align-items-center'>
                        <div className='form-check'>
                            ...
                            <label className='form-check-label' htmlFor='flexCheckDefault18'>سئو</label>
                        </div>
            ...
            <a className=' p-0 mb-0 mt-2 btn-more d-flex align-items-center' data-bs-toggle='collapse' href='#multiCollapseExample1' role='button' aria-expanded='false' aria-controls='multiCollapseExample1'>
                مشاهده <span className='see-more ms-1'>بیشتر</span><span className='see-less ms-1'>کمتر</span><i className='fas fa-angle-down ms-2'></i>
            </a>
        </div>
    </div>);
}
